...
public class CaptureWalkthroughCustomEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        System.IO.DirectoryInfo dirInfo = new System.IO.DirectoryInfo(capture.directory);
        string parentName = dirInfo.Parent != null ? dirInfo.Parent.Name : "";
        GUILayout.Label(parentName + "/" + dirInfo.Name);
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            string fileName = Path.Combine(capture.directory, Path.GetFileName(capture.fileName));
