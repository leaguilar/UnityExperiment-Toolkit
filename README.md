# Getting Started
The UnityExperiment-Toolkit allows you to perform experiments using agent-based simulations, cognitive walkthroughs and multiplayer based VR experiments.
...
- **Git**: A tool that allows you to keep up to date with the latest changes of the UnityExperiment-Toolkit.
...
GitHub desktop is a user interface for the version-control tool _git_. We will use _git_ to download the latest version of the UnityExperiment-Toolkit and get the newest updates later.
...
## 2. Installing the UnityExperiment-Toolkit
In GitHub Desktop, choose _File > Clone repository... > URL_ and enter the following URL: `https://github.com/leaguilar/UnityExperiment-Toolkit.git`. Below, you will see where the toolkit will be saved on your system. Then, click _clone_.
